...
2.  CookBuddy shows a list of recipes, in _grid view_
+
Use case ends.
...
* 3a. The name cannot be found, or the index is invalid.
+
[none]
** 3a1. `CookBuddy` throws an error message.
+
...
[none]
* 2a. The name cannot be found, or the index is invalid.
+
[none]
** 2a1. `CookBuddy` throws an error message.
+
Use case ends.
...
3. User confirms, and edited recipe is saved to disk
+
Use case ends.
